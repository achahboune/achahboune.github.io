...
export default function Page() {
  ...
  // Scroll-to-top
  useEffect(() => {
    const onScroll = () => setShowScrollUp(window.scrollY > 600)
    onScroll()
  ...
  return (
    <div className="relative min-h-screen text-slate-200 selection:bg-blue-500/30">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="max-w-2xl">
              ...
              <div className="space-y-4 mb-10 text-lg text-slate-400 leading-relaxed">
                <p>
                  <strong>Real-time IoT monitoring &amp; traceability:</strong> Measure{" "}
                  <span className="text-slate-200">temperature, humidity, vibration, and CO₂</span>{" "}
                  across the entire supply chain (warehouses, trucks, containers) — with satellite-ready connectivity.
                </p>
                <p>
                  <strong>Immediate alerts:</strong> Automatic detection of excursions and deviations, with instant notifications to prevent loss.
                </p>
                <p>
                  <strong>Blockchain-proof evidence:</strong> Every sensor event is timestamped and sealed on-chain to create tamper-evident records ready for audits and disputes.
                </p>
                <p>
                  <strong>Automated payments:</strong> Smart contracts trigger insurance claims and SLA penalties automatically, based on sealed sensor evidence.
                </p>
              </div>
      ...
      <button
        ...
        title="Back to top"
        onClick={scrollToTop}
        className={`fixed bottom-6 right-6 z-50 inline-flex h-12 w-12 items-center justify-center rounded-full
        ...
        hover:from-blue-500 hover:to-cyan-300 hover:shadow-[0_14px_40px_rgba(34,211,238,0.45)]
